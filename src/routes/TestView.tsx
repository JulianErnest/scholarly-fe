...
<Container  maxWidth="false" sx={{ bgcolor: '#008037', height: '100vh' }}>
    <Container>
        ...
        >           <ListItem>
                ...
                <ListItem>
                    <ListItemText primary="Test Name" secondary="Sample Test Name" />
                </ListItem>
                <Divider variant="inset" component="li" />
                <ListItem>
                    <ListItemText primary="Time Limit" secondary="Sample Time Limit" />
                </ListItem>
                </List>
            </Grid>
            <Grid item xs={4}>
            ...
            <Grid item xs={3} sx={{
                ...
                <Paper elevation={3} />
                <Typography textAlign="center" variant="h4" color="#F1B461" sx={{ my: 2}}>
                    Scholarly
                </Typography>
